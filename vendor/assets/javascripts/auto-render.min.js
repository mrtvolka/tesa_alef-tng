...
function formatSpaces(str) {
    ...
    if (match == null) { // Did it match?
        ...
        var prefix = '\\begin{matrix}';
        var suffix =  '\\end{matrix}';
